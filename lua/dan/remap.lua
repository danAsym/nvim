...
local normal_mappings = {
	...
	["<leader>a"] = {
		...
		p = { "<cmd>Copilot enable<CR>", "Enable Copilot" },
		P = { "<cmd>Copilot disable<CR>", "Disable Copilot" },
	},
	...
	["<leader>l"] = {
		...
		S = { tels.lsp_document_symbols, "Document Symbols" },
		b = { tels.lsp_dynamic_workspace_symbols, "Workspace Symbols" },
		i = {
			function()
